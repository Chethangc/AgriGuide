...
<style type="text/css">
    ...
    body {
        margin:0;
        padding:0;
        background:url(media/images/4.png);
        width:100%;
        height:100%;
...
<div class="r">
    <img src="media/images/logo.png" height="550px" width="550px" class="gr1"/>
    <img src="media/images/6.gif" width="500px" height="500px" class="ref" class="gr1"/>
</div> <br><br>
...
<div border=1 id="tb1" >
    ...
    <center>
        <div class="inputbox">
            ...
            <input type="text" name="uname" id="un" max="100" min="3"placeholder="Enter the User Name" class="inp">
        </div><br>
        <div class="inputbox">
